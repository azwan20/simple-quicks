import HeaderChat from "../allChat/header";
import HeaderDetail from "../chatDetail/headerDetail";

export default function HeaderSupport({ handleSupport }) {
  return (
    <>
      <span className="d-flex justify-content-between align-items-center details pb-0">
